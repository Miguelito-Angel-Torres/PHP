<?php $status_controller = new UsersController(); ?>
<?php if($_POST['r']=='users-delete' && $_SESSION['role_'] == 'Admin' && !isset($_POST['crud'])){
    $status = $status_controller->get($_POST['user']);
    if(empty($status)){?>
        <div class="container">
            <p class="item error">NO existe el status_id <?php $_POST['user_'] ?></p>
        </div>
...
<?php } else if($_POST['r']=='users-delete' && $_SESSION['role_']== 'Admin' && $_POST['crud'] == 'del' ) {
        ...
        ?>
            ...
            <?php header( "refresh:2;url=usuario" ) ?>
